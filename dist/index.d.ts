...
declare const _default: {
    http: {
        Server: typeof import("./core/http/src/Server").default;
        Response: typeof import("./core/http/src/Response").default;
        statusCodes: {
            ACCEPTED: number;
            BAD_GATEWAY: number;
            BAD_REQUEST: number;
        ...
        Endpoint: typeof import("./core/http/src/Endpoint").default;
    };
};
